...
import { ColorValueHex, EyeColorType, SdkIncomingMessages, SdkMessageResponseType } from './message_types';
...
export declare class AvaturnSDK extends Messaging<SdkMessageResponseType, SdkIncomingMessages> {
    ...
    /**
      Sets eye color.
      @param value string, see EyeColorType
      @group Options
     */
    setEyeColor(value: EyeColorType): Promise<null>;
    /**
      Sets hair color.
    ...
    /**
      ...
      @param value Number from -100 to 100. 0 = no correction.
      @group Options
     */
     ...
     * @group Options
     */
    getEyeColor(): Promise<EyeColorType>;
    /**
